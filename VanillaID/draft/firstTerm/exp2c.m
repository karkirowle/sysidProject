% Experiment 2c - Motif identification on two-gene net within new simulation
% environment
...
% --------------- Two-gene activation toy example -------------------------

% Parameters
initialConditions = [40,10];
timeStep = 1000;
precision = 0.1;
sim = geneGraph(2);
sim = sim.degradation(1, -0.8);
sim = sim.degradation(2, -0.8);
sim = sim.activation(1,2,10,2);
sim = sim.activation(2,1,10,2);
