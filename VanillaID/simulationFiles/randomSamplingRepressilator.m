...
% ------------------------- DESCRIPTION -----------------------------------
% Random sampling based repressilator algorithm
...
% Preallocation
randomIdxMatrix = zeros(length(SNR),numRealisations,50);
...
for i=1:length(SNR)
    for r=1:numRealisations
        ...
        idx = randperm(length(0:0.01:10));
        randomIdxMatrix(i,r,:) = idx(1:50);
